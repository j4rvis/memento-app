...
- [ ] 2.1 Run `pnpm generate-newspapers` and confirm PDFs are generated successfully
- [ ] 2.2 Spot-check a themed config (e.g. broadsheet or vintage) to confirm theme renders correctly
