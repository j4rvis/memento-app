  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <form action={async () => { "use server"; await generateEdition(id); }}>
          <Button size="sm">
            <Eye className="mr-2 h-4 w-4" />
            Generate & Preview
          </Button>
        </form>
        <form action={async () => { "use server"; await deleteNewspaper(id); }}>
      ...
      <form
        action={async (formData) => { "use server"; await updateNewspaper(id, formData); }}
